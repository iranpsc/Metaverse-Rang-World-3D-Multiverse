...
*/
[AddComponentMenu("Meta/Network Manager")]
public class Meta_NetworkManager : NetworkManager
{
    [Header("⚙️ Auto Network Settings")]
    public bool TestState;

    // Overrides the base singleton so we don't
    // have to cast to this type everywhere.
    public static new Meta_NetworkManager singleton => (Meta_NetworkManager)NetworkManager.singleton;
