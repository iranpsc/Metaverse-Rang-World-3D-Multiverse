...
{
    [Header("References")]
    [SerializeField] private RealtimeWebSocketG7RoomLobbyTestController roomLobbyController;
    ...
    {
        if (roomLobbyController == null) roomLobbyController = FindObjectOfType<RealtimeWebSocketG7RoomLobbyTestController>();
