...
{
    public class GrpcEnvironmentGameServerUIController : MonoBehaviour
    {
        ...
        private DedicatedGameServerRealtimeRoomBinder binder;
        ...
        {
            DedicatedGameServerRealtimeRoomBinder currentBinder = DedicatedGameServerRealtimeRoomBinder.Instance;

            if (currentBinder == null)
            {
                ApplyMissingBinderState();
                Log("Persistent DedicatedGameServerRealtimeRoomBinder instance is missing.");
                return;
            }
            ...
            ApplyCurrentBinderState();
            Log("Scene UI connected to the persistent DedicatedGameServerRealtimeRoomBinder.");
        }
        ...
        {
            if (verboseLogs) Debug.Log("[GrpcEnvironmentGameServerUIController] " + message);
        }
